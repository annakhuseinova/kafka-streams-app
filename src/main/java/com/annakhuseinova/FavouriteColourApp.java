...
public class FavouriteColourApp {
    ...
    public static void main(String[] args) {
        ...
        // we disable the cache to demonstrate all the "stops" involved in the transformation - not recommended in prod
       ...
       KTable<String, Long> favouriteColours = usersAndColoursTable
               // step 5 - we group by colour within the KTable
               .groupBy((user, colour) -> new KeyValue<>(colour, colour))
               .count(Named.as("countByColours"));

       // step 6 - we output the results to a Kafka Topic - don't forget the serializers
